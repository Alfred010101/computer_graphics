...
public class Ex4RandomEllipses extends JPanel
{
    ...
    {
        SwingUtilities.invokeLater(() -> new SnippetFrame(new Ex4RandomEllipses(), "Ellipses Slider").setVisible(true));
    }
    ...
    class WorkPanel extends JPanel
    {
        ...
        protected void paintComponent(Graphics g)
        {
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                g2.setColor(new Color(new Random().nextInt(256), new Random().nextInt(256), new Random().nextInt(256)));
    ...
    class ControlPanel extends JPanel
    {
        ...
        public ControlPanel()
        {
            ...
            slider = new JSlider(JSlider.HORIZONTAL, 1, 100, n); // Rango del slider
